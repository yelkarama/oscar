...
import org.oscarehr.integration.fhirR4.model.Destination;
import org.oscarehr.integration.fhirR4.model.Sender;
import org.oscarehr.integration.fhirR4.resources.constants.ActorType;
...
public abstract class AbstractFhirMessageBuilder<T extends BaseResource> {
	...
	protected static final String resourceToJson( org.hl7.fhir.r4.model.BaseResource resource ) {
		if( resource == null ) {
			return "";
		}

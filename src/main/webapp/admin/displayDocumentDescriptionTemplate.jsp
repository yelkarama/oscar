...
<html>
    ...
    <h4><bean:message key="dms.documentEdit.formDocDesc" /> </h4>
    <div class="well">
        <form  method="post" name="docDescriptionForm" action="displayDocumentDescriptionTemplate.jsp" >
            ...
            <% if (providerNo==null) {%>
            <span class="lead"><bean:message key="provider.setDocumentDescriptionTemplate.setClinicDefault" /></span>
            <%}%>
            <p>
            ...
            <table style="visibility:hidden" id="tblDesc">
                ...
                <tr>
                    <td colspan="2"><input type="button" class="btn" value="<bean:message key="provider.setDocumentDescriptionTemplate.Add" />" id="addDescription" onclick="adddocDescription()">
                        <input type="button" class="btn" value="<bean:message key="provider.setDocumentDescriptionTemplate.Update" />" id="updateDescription" onclick="updatedocDescription()">
                        <input type="button" class="btn" value="<bean:message key="provider.setDocumentDescriptionTemplate.Delete" />" id="deleteDescription" onclick="deletedocDescription()">
                    </td>
                </tr>
            </table>
        </form>

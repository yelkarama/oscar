            ...
            if (ferengi) {
				...
				while ($("#page_"+pageNo).length > 0) {
					...
					if ( imgWidth && imgWidth.length > 3) { 
						...
						scaleX = eFormPageWidthPortrait/imgWidth;
...
//alert(data.body) //2021-May-08
                    ...
                    e.onclick = function() {
                        ...
                        switch (strUser) {
                            case "LinkTextBoxfunction":
                                // x = prompt('Please enter function action - such as onblur', 'onblur');  //2020-May-23
                                //y = prompt('Please enter function for ' + x + ' - such as '+strUser+'(this)', strUser + '(this)');
                                x = 'onblur'
                                y = 'LinkTextBoxfunction(this)'
                                break;
                            ...
                            case "LinkXBoxfunction": // if{} below
                                ...
                                //y = prompt('Please enter function for ' + x + ' - such as '+strUser+'(this)', strUser + '(this)');
                                x = 'onclick'
                                y = 'myupdate(this);LinkXBoxfunction(this)'
                                break;
                            ...
                            case "fixSin":
                                ...
                                zz = myRe.split(",")
                                x = prompt('Please enter function action - such as onblur', 'onblur'); //2020-Mar-23
                                y = prompt('Please enter RegEx for ' + x, strUser + '(this,' + zz[0] + ',' + zz[1] + ')');
                                break;
                            default:
                                x = prompt('Please enter function action - such as onclick', 'onclick'); //2020-Mar-23
                                y = prompt('Please enter function for ' + x + ' - such as alert(this)', strUser + '(this)');
                        }


                        //**********************************
                        $xBoxTemplate.find(':input').css('background-color', 'lime') // 2020-May-17  
                        $xBoxTemplate.find(':input').attr(x, y);
                        $rBoxTemplate.find(':input').css('background-color', 'red');
                        $rBoxTemplate.find(':input').attr(x, y);
        ...
        function initTextboxTemplateTab($tab) {
            ...
            $db_tag_select.on('selectmenuchange', (function(event, data) {
                //alert($db_tag_select.val())   //newwork
            ...
            function titleSnippet() {
                ...
                $("#someName").change(function() {
                    ...
                    //alert($textBoxTemplate.find(':input').attr('title')) 
                });


                $("#someName").focus(function() {
                    //alert($('#someName').val())
                    //alert("This has focus") // 2020-May-12
                    $textBoxTemplate.find(':input').attr('title', $('#someName').val());
            ...
            $oscarDbCheckbox.on('change', function(event, ui) { //2020-May-15
                ...
                //alert(this.id)
                if ($(this).is(':checked')) {
                    //alert(this.checked)   //workinghere
                    //$textBoxTemplate.find(':input').css("background-color", "rgba(245, 190, 255, 0.50)");  //2020-May-15


                    dbWindow($db_tag_select) //open db tag window  //2021-May-06
                    //alert($db_tag_select.val())
                    //$db_tag_select.val("addressline")
                    ...
                    $('#someName').val($db_tag_select.val()); // 2020-May-03
                    //$('#someName').focus()  //  2020-May-12
                    $('#someName').trigger("change"); //  2020-May-12

                    //**************************************************************************************
                    $textBoxTemplate.find(':input').attr('oscarDB', $db_tag_select.val());
                    //$textBoxTemplate.find(':input').attr('title',$db_tag_select.val()); //2019-Feb-13
                    $textAreaTemplate.find('textarea').attr('oscarDB', $db_tag_select.val());
                    //$textAreaTemplate.find('textarea').attr('title', $db_tag_select.val());  //2019-Feb-13
                } else {
                    // alert(this.checked)
                    //$textBoxTemplate.find(':input').css("background-color", "");  //2020-May-15
...
//alert($db_tag_select.val())
            ...
            $oscarDbCheckbox2.on('change', function(event, ui) {
                if ($(this).is(':checked')) {
                    ...
                    e.onclick = function() {
                        ...
                        if (strUser.indexOf('dateReformat') > -1) {
                            var zz = "'yyyy-mmm-dd'"
                            //$textAreaTemplate.find(':input').attr('title', 'Double-click to compress, shift-click to reset');
                            x = prompt('Please enter function action - such as onblur', 'onblur'); //newwork
                            y = prompt('Please enter function for ' + x + ' - dateReformat(this)', strUser + '(this,' + zz + ')');
                            $textBoxTemplate.find(':input').attr(x, y);
                        ...
                        $textAreaTemplate.find('textarea').attr(x, y);
                        if (y.indexOf('removeLineFeeds') > -1) {
                            $textAreaTemplate.find(':input').attr('title', 'Double-click to compress, shift-click to reset');
                        }
                    ...
                    closeNavGen() //close side bar
                    //$textBoxTemplate.find(':input').val("")
                    //$textAreaTemplate.find('textarea').val("")
                    $textBoxTemplate.find(':input').removeAttr(x); //working here
                    $textAreaTemplate.find('textarea').removeAttr(x);
            ...
            $('#toggleGOscarDbCheckbox5').on('change', function(event, ui) { //??????
                if ($(this).is(':checked')) {
                    ...
                    //$textBoxTemplate.find(':input').css('background-color', 'orange')
                    var e = document.getElementById("MeasureSelect");
                    //$(e).css('background-color', 'yellow')
                    $(e).change(function() {
                        var y = $(this);
                    ...
                    //alert((e).value)
                    measureTagfx()
                    //$textBoxTemplate.find(':input').attr('oscarDB',(e).value); 
                } else {
                    $('#MeasureSelect').hide()
                    $('#oscarDbTagSelect-button').show()
                    measureTagfx(y)
        ...
        function initSignatureTemplateTab($tab) {
            ...
            addDraggableStamp($dragFrame51, "signatureStamp", 255, 50, "BNK.png", "signatureStamp");  

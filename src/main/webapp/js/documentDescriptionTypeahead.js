// this has dependencies on jQuery UI autocomplete
// and ManageDocumentAction.searchDocumentDescriptions()
...
function setupDocDescriptionTypeahead(docId) {
    if(jQuery("#docDesc_" + docId) ){
        ...
        var  url =  "../dms/ManageDocument.do?method=searchDocumentDescriptions";

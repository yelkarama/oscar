	...
	this.create = function(){
		...
		if (options.linkHover) {
			...
			allLinks.on("hover", (
				function(){
					var menuitem = $(this);
					$('.'+options.linkHover).removeClass(options.linkHover).trigger("blur").parent().removeAttr('id');
					$(this).addClass(options.linkHover).trigger("focus").parent().attr('id','active-menuitem');
				},
				function(){
					$(this).removeClass(options.linkHover).trigger("blur").parent().removeAttr('id');
				}
			));
		};

		if (options.linkHoverSecondary) {
			container.find('.fg-menu li').on("hover", (
				function(){
...
Menu.prototype.flyout = function(container, options) {
	...
	container.addClass('fg-menu-flyout').find('li:has(ul)').each(function(){
		...
		$(this).find('a:eq(0)').addClass('fg-menu-indicator').html('<span>' + $(this).find('a:eq(0)').text() + '</span><span class="ui-icon '+options.nextMenuLink+'"></span>').on("hover",(
			function(){

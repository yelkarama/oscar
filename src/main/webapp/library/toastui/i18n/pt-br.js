...
/**
 * @fileoverview I18N for PortuguÃªs
 * @author NÃ­colas Huber <nicolasluishuber@gmail.com>
 */
...
_editorCore__WEBPACK_IMPORTED_MODULE_0___default().setLanguage(['pt', 'pt-BR'], {
    ...
    Code: 'CÃ³digo',
    Line: 'Linha',
    Blockquote: 'Bloco de citaÃ§Ã£o',
    'Unordered list': 'Lista nÃ£o ordenada',
    'Ordered list': 'Lista ordenada',
    Task: 'Tarefa',
    Indent: 'Recuo Ã  esquerda',
    Outdent: 'Recuo Ã  direita',
    'Insert link': 'Inserir link',
    'Insert CodeBlock': 'Inserir bloco de cÃ³digo',
    ...
    'Add column to left': 'Adicionar coluna Ã  esquerda',
    'Add column to right': 'Adicionar coluna Ã  direita',
    'Remove row': 'Remover linha',
    'Remove column': 'Remover coluna',
    'Align column to left': 'Alinhar Ã  esquerda',
    'Align column to center': 'Alinhar ao centro',
    'Align column to right': 'Alinhar Ã  direita',
    'Remove table': 'Remover tabela',
    'Would you like to paste as table?': 'VocÃª gostaria de colar como mesa?',
    'Text color': 'Cor do texto',
    'Auto scroll enabled': 'Rolagem automÃ¡tica habilitada',
    'Auto scroll disabled': 'Rolagem automÃ¡tica desabilitada',
